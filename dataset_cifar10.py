...
model.fit_generator(datagen.flow(X_train, y_train, batch_size = 32), epochs = 25, steps_per_epoch = X_train.shape[0] / 32, validation_data = (X_val, y_val), callbacks = [checkpoint])
